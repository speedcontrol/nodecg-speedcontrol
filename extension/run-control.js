...
function changeActiveRun(id) {
    return __awaiter(this, void 0, void 0, function () {
        var runData, noTwitchGame, status_1, gameTwitch, _a, srcomGameTwitch, err_1;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    noTwitchGame = false;
                    if (!twitchAPIData.value.sync) return [3 /*break*/, 6];
                    status_1 = helpers_1.bundleConfig().twitch.streamTitle
                    ...
                    if (!(!gameTwitch && runData.game)) return [3 /*break*/, 3];
                ...
                case 5:
                    ...
                    helpers_1.to(twitch_api_1.updateChannelInfo(status_1, gameTwitch || helpers_1.bundleConfig().twitch.streamDefaultGame));
 ...
 */
function modifyRun(runData, prevID) {
    return __awaiter(this, void 0, void 0, function () {
        var data, allNamesAdded, ms, ms, index, prevIndex;
        return __generator(this, function (_a) {
            try {
