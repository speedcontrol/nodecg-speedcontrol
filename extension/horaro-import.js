        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    Object.keys(opts_1.columns.custom).forEach(function (key) {
                        var val = optsO.columns.custom[key];
                        opts_1.columns.custom[key] = (val === null) ? -1 : val;
                    });
                    hashesSeen_1 = [];
                                ...
                                switch (_e.label) {
                                    ...
                                    case 6:
                                        ...
                                        Object.keys(opts_1.columns.custom).forEach(function (col) {
                                            var str = parseMarkdown(run.data[opts_1.columns.custom[col]]).str;
                                            if (str) {
