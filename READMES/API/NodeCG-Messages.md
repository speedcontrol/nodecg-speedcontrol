...
- [Messages Received (*sendMessage/sendMessageToBundle*)](#messages-sent-listenfor)
  ...
  - [timerReset `(force: boolean)`](#timerReset-`(force:-boolean)`)
  - [timerStop `({ id: string, forfeit: boolean})`](#timerStop-`({-id:-string,-forfeit:-boolean})`)
  - [timerUndo `(id: string)`](#timerUndo-`(id:-string)`)
  - [timerEdit `(time: string)`](#timerEdit-`(time:-string)``)
